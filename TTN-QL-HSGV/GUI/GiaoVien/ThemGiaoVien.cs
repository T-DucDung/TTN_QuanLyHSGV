...
namespace TTN_QL_HSGV.GUI.GiaoVien
{
    public partial class ThemGiaoVien : Form
    {
        ...
        private void ButtonThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DTO.GiaoVien  gv = new DTO.GiaoVien(0, textBoxTenGV.Text, textBoxDiaChi.Text, textBoxGT.Text, textBoxSDT.Text, textBoxChucVu.Text, int.Parse(comboBoxDayMon.SelectedValue.ToString()));
        ...
        private void ButtonLayAnh_Click(object sender, EventArgs e)
        {
            ...
            {
                urlGV = open.FileName;
                pictureBox1.Image = new Bitmap(urlGV);

                MessageBox.Show(urlGV);
            }
        }
    }
}
